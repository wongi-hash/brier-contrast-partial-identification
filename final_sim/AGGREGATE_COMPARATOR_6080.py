...
def main() -> None:
    comp_frames, comp_prov = collect(HERE / "comparator_out_v2", "comparator")
    mirror_frames, mirror_prov = collect(HERE / "comparator_mirror_out", "mirror")
    ...
    csv_path = HERE / "COMPARATOR_6080_AGGREGATED.csv"
    ...
    lines = [
        ...
        "- All proportions have Wilson 95% intervals in `COMPARATOR_6080_AGGREGATED.csv`.",
    ...
    rendered = "\n".join(lines) + "\n"
    md_path = HERE / "COMPARATOR_6080_RESULTS.md"
    unified_path = HERE / "COMPARATOR_UNIFIED_TABLE_6080.md"
    ...
    manifest_path = HERE / "COMPARATOR_6080_MANIFEST.json"
